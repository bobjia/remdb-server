"""
Vector Search Example for RemDB

This example demonstrates how to use the vector search functionality in RemDB.
"""
...
def main():
    ...
    with remdb.connect() as db:
        try:
            # Get the table (assuming it already exists with vector data)
            table = db.get_table("products")
            
            # Example: Search for similar products using vector embeddings
            ...
            print("Table not found. Please create a table with vector data first.")
